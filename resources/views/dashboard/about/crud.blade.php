        ...
        <div class="col-sm-12">
            <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $about->id }}Edit"><i
                                                class="bx bx-pencil"></i>Изменить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $about->id }}Edit"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Данные RU</label>
                                                                        <input class="form-control" id="exampleFormControlInput1" required type="text"
                                                                            name="data_ru" value="{{ $about->data_ru }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Данные UZ</label>
                                                                        <input class="form-control" id="exampleFormControlInput1" required type="text"
                                                                            name="data_uz" value="{{ $about->data_uz }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Данные EN</label>
                                                                        <input class="form-control" id="exampleFormControlInput1" required type="text"
                                                                            name="data_en" value="{{ $about->data_en }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card-footer text-end">
                ...
                <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                    data-bs-target="#exampleModalCenter{{ $about->id }}"><i class="bx bx-trash"></i>Удалить</button>
